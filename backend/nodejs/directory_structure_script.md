...
mkdir server/src/controllers server/src/db server/src/middlewares
mkdir server/src/models server/src/routes server/src/utils

touch server/src/app.js server/src/index.js
touch server/src/controllers/.gitkeep
touch server/src/db/connection.js server/src/middlewares/.gitkeep
touch server/src/models/.gitkeep
touch server/src/routes/.gitkeep server/src/utils/.gitkeep
touch server/.env server/.env.sample server/.gitignore
```
...
cat <<\EOF > server/src/db/connection.js
import mongoose from "mongoose"
import dotenv from "dotenv"
dotenv.config()
export const connectDB = async () => {
